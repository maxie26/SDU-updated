...
<head>
    ...
    <style>
        ...
        @media (max-width: 991px) {
            body { padding: 1rem 0; }
            .profile-summary, .profile-edit { padding: 1.5rem; }
        }
    </style>
</head>
<body>
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            <div>
                <h1 class="h3 mb-1">Profile Center</h1>
                <p class="text-muted mb-0">View and update your account details in one place.</p>
            </div>
            <a href="<?php echo $backHref; ?>" class="btn btn-outline-secondary">
                ...
                <div class="profile-edit">
                    ...
                    <form id="profileUpdateForm" novalidate>
                        ...
                        <div class="mt-3">
                            ...
                            <input type="text" class="form-control" name="office" value="<?php echo htmlspecialchars($user_data['office']); ?>" placeholder="e.g. Human Resources">
                        </div>
                        <?php endif; ?>
                        <div class="mt-3">
